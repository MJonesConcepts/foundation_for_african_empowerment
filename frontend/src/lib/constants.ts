...
export const FOOTER_COLUMNS: FooterColumn[] = [
  {
    ...
    href: '/our-network',
    links: [
      { label: 'Tanzania and Zanzibar Island', href: '/our-/values' },
      { label: 'Partner Schools', href: '/our-network/partners' },
      { label: 'Explore Chemka Village', href: '/our-network/ceos' },
      { label: 'Explore Enjoro Maasai Community', href: '/our-network/global-organization' },
    ],
  },
  {
    ...
    href: '/our-mission',
    links: [
      { label: "Change Children's Lives", href: '/our-mission/teachers' },
      { label: 'Why Disability Inclusive Education', href: '/our-mission/alumni' },
      { label: 'Emergency Response Initiatives', href: '/our-mission/communities' },
    ],
  },
  {
    heading: 'How We Work',
    href: '/methodology',
    links: [
      { label: 'Our Approach', href: '/methodology/teaching' },
      { label: 'Projects', href: '/methodology/community-impact-lab' },
      { label: 'Our Impact', href: '/methodology/accelerator' },
    ],
  },
  {
  ...
  },
  {
    heading: 'FAE Africa',
    links: [
      { label: 'The Foundation for African Empowerment', href: '/' },
    ],
  },
];

export const SOCIAL_LINKS = [
  { platform: 'Facebook', href: 'https://www.facebook.com/FAEAfrica', icon: 'facebook' },
  { platform: 'X / Twitter', href: 'https://x.com/FAEAfrica', icon: 'x-twitter' },
  { platform: 'Instagram', href: 'https://www.instagram.com/FAEAfrica', icon: 'instagram' },
  { platform: 'LinkedIn', href: 'https://www.linkedin.com/company/FAEAfrica/', icon: 'linkedin' },
];
